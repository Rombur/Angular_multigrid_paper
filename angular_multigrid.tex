...
\ead{ragusa@ne.tamu.edu}

\author{Jim E. Morel\fnref{label1}}
\ead{morel@ne.tamu.edu}
...
%%% no, we use Galerkin quads so this equation is WRONG \approx \sum_{d=1} w_d \Psi(\br,\bo_d,E)A_l^{m}(\bo_d)$ 
...
%, when compared to Sweep and DSA preconditioning in the next two tests.
